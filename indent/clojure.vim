...
" Custom:
setlocal lispwords+=defpartial,defpage,deftest,defroutes,defparser,let->>,defparsertest,>>,match,defentity,defdb,defproject,definst,defsynth,defform,defform-,defrule,defmigration,defremote,defmeter,deftimer,defgauge,defcounter,defhistogram,testing
